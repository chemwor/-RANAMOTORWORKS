...
import seviceDetailsThumb_1 from "@/assets/images/media/ford.jpg";
import seviceDetailsThumb_2 from "@/assets/images/media/wheel.jpg";

import seviceDetailsIcon_1 from "@/assets/images/icon/car-wash.png";
import seviceDetailsIcon_2 from "@/assets/images/icon/car-painting.png";
import seviceDetailsIcon_3 from "@/assets/images/icon/safety.png";
...
const content_data: ContentType = {
   ...
   sidebar_links: ["/maintenance_wash", "/paint_protection", "/auto_detailing",],
}
            ...
            <div className="row">
               <div className="col-lg-8">
                  <div className="service-post">
                     <div className="btn-line fw-500 text-uppercase">Ceramic Coating</div>
                     ...
                     <div className="service-sidebar md-mt-80">
                        <div className="service-category">
                           <ul className="style-none">
                              <li><Link href="/ceramic_coating" className="active">Ceramic Coating</Link></li>
