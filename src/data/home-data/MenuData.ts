...
const menu_data: MenuItem[] = [

    {
        ...
        link: "ceramic_coating",
        sub_menus: [
            { link: "/ceramic_coating", title: "Ceramic Coating" },
            { link: "/maintenance_wash", title: "Maintenance Wash" },
            { link: "/paint_protection", title: "Paint Protection" },
            { link: "/auto_detailing", title: "Auto Detailing" },
        ],
    },
    // {
    //     id: 2,
